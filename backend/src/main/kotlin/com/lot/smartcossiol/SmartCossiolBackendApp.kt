...
class SmartCossiolBackendApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes smartCossiolBackend.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<SmartCossiolBackendApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(SmartCossiolBackendApp::class.java)
